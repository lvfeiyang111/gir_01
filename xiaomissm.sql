...
CREATE TABLE `admin` (
  ...
  `a_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `a_pass` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`a_id`)
...
INSERT INTO `admin` VALUES ('2', 'lfy', '7c4a8d09ca3762af61e59520943dc26494f8941b');
...
INSERT INTO `product_info` VALUES ('12', '小米电视6', '65英寸 原装三星屏 3840×2160 真4K', '8999', 'xmTV4-65.jpg', '500', '3', '2022-03-09');
...
INSERT INTO `product_info` VALUES ('17', '小米6', '玻璃金属 白色 6GB内存 128GB闪存', '2899', 'xm6.jpg', '50', '1', '2022-03-08');
INSERT INTO `product_info` VALUES ('18', '小米MAX2', '全金属 金色 4GB内存 64GB闪存', '1599', 'xmMAX2.jpg', '50', '1', '2022-03-01');
...
-- Records of xmorder
-- ----------------------------
INSERT INTO `xmorder` VALUES ('abcd111222333444777888999000wwww', '1', '1', '9996.00', '尽快送到', '待发货', '2022-03-06 14:01:49');
